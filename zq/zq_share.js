/*
脚本源地址：https://raw.githubusercontent.com/shaolin-kongfu/js_scripts/main/zq/zq_share.js


10 6,12,18 * * * https://raw.githubusercontent.com/solar24/JavaScript/main/zq/zq_share.js 中青火爆转发
...
function share_reward(timeout=0) {
    return new Promise((resolve) => {
        let reward;
        if (hour >= 5 && hour <= 10) {
            reward = 'one'
